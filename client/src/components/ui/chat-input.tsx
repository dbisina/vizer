...
interface ChatInputAttachProps extends React.ComponentProps<typeof Button> {
        onAttach?: () => void;
}
...
function ChatInputAttach({
        ...
        const context = useContext(ChatInputContext);
        const onAttach = onAttachProp ?? context.onAttach;
...
ChatInputAttach.displayName = "ChatInputAttach";
...
export { ChatInput, ChatInputTextArea, ChatInputSubmit, ChatInputAttach };
