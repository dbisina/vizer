...
const AnimatedLoadingSkeleton = () => {
    ...
    return (
        <motion.div
            className="w-full max-w-7xl mx-auto p-6 bg-background rounded-xl"
            variants={frameVariants}
            initial="hidden"
            animate="visible"
        >
            <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-muted to-muted/50 p-8">
                    ...
                    {[...Array(config.numCards)].map((_, i) => (
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                animate={{
                                    background: ["hsl(var(--muted))", "hsl(var(--muted) / 0.8)", "hsl(var(--muted))"],
                                }}
